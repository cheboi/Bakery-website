...
namespace Bakery.Pages
{
    public class OrderModel : PageModel
    {
        ...
        [BindProperty, EmailAddress, Required, Display(Name ="Your Email Adress") ]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                var body = $@"< p > Thank you, we have received your order for { OrderQuantity}
...
We will contact you if we have questions about your order.Thanks! < br /> ";
                using (var smtp = new SmtpClient())
                {
                    ...
                    message.Subject = "Buret Coffee - New Order";
                    message.Body = body;
                    message.IsBodyHtml = true;
                    message.From = new MailAddress("sales@Buretcoffee.com");
